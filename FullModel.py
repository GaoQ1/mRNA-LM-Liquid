...
class FullModel(torch.nn.Module):
    def __init__(
        ...
        self.utr3 = BertForMaskedLM.from_pretrained("pretrained_models/mrna_3utr_model")
        self.cds = BertForMaskedLM.from_pretrained("pretrained_models/CodonBERT")
        
        print("\nUtr5 Model Parameters:")
        print_trainable_parameters(self.utr5)
        
        print("\nUtr3 Model Parameters:")
        print_trainable_parameters(self.utr3)
        
        print("\nCds Model Parameters:")
        print_trainable_parameters(self.cds)
