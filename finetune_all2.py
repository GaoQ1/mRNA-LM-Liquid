...
# torch.save(trainer.model.state_dict(), './outputs/liver/finetuned_model.pt')
# torch.save(trainer.model.state_dict(), './outputs/5class/finetuned_model.pt')


# # 然后，使用torch.load加载模型状态字典
model_state_dict = torch.load('./outputs/tr/finetuned_model.pt')
