...
elif args.task == "hek293t":
    ds_train, ds_valid, ds_test = build_hek293t_dataset()
elif args.task == "rabies":
    ds_train, ds_valid, ds_test = build_rabies_dataset()
elif args.task == "gfp":
    ds_train, ds_valid, ds_test = build_gfp_dataset()
...
# 保存微调后的模型
# output_dir = "./outputs/hek293t"
output_dir = "./outputs/rabies"
# output_dir = "./outputs/gfp"


os.makedirs(output_dir, exist_ok=True)
torch.save(trainer.model.state_dict(), os.path.join(output_dir, 'finetuned_model.pt'))
